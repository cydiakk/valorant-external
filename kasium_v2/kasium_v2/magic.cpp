		...
		for (int i = 0; i < 10; ++i) {
			...
			if (magic_o_read_proxy && magic_o_write_proxy && magic_o_datahk && magic_original_func) {
				if (utils::is_valid_addr(worldcrypt_key) && utils::is_valid_addr(worldcrypt_state)) {
					//std::cout << "	-	Autoupdater		-	" << std::endl;
					//std::cout << "uworld" << std::endl;
					//std::cout << "	key: 0x" << std::hex << worldcrypt_key << std::endl;
					//std::cout << "	state: 0x" << std::hex << worldcrypt_state << std::endl;
					//std::cout << "magic" << std::endl;
					//std::cout << "	magic_o_writeproxy: 0x" << std::hex << magic_o_write_proxy << std::endl;
					//std::cout << "	magi_readproxy: 0x" << std::hex << magic_o_read_proxy << std::endl;
					//std::cout << "	magic_original_func: 0x" << std::hex << magic_original_func << std::endl;
					return true;
				}
			}
			Sleep(1000);
